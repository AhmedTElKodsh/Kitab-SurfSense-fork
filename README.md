...
# Kitab (formerly SurfSense) - POC Fork

> **Note**: This is a POC fork of SurfSense focused on text rebranding and cloud deployment. Some technical documentation and links still reference the original SurfSense project.

While tools like NotebookLM and Perplexity are impressive and highly effective for conducting research on any topic/query, Kitab elevates this capability by integrating with your personal knowledge base. It is a highly customizable AI research agent, connected to external sources such as Search Engines (SearxNG, Tavily, LinkUp), Slack, Linear, Jira, ClickUp, Confluence, Gmail, Notion, YouTube, GitHub, Discord, Airtable, Google Calendar, Luma, Elasticsearch and more to come.
...
Save content from your own personal files _(Documents, images, videos and supports **50+ file extensions**)_ to your own personal knowledge base .
...
### Audio & Video _(Always Supported)_
